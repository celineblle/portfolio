...
const macBu2Commentaire: string =
  'Lecture du livre "Coder proprement" de Robert C. Martin pour integrer des bonnes pratiques de développement.';
...
const shortDescription: string = "Inspiré de Netflix, Youtube et Disney+, Short Digital propose un ensemble de videos autour du developpement web. Vous y trouverez de quoi apprendre un nouveau language ou comment ce petit truc de css qui fait toute la difference.";
...
const kanbanDescription: string = "Projet simple de kanban pour appliquer en situtation les notions durant l'apprentissage d'Angular.";
